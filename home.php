...
<body style="overflow-x: hidden;" class="dashboard topnav">
          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
                ...
                <img src="asset/img/logo.png" class="img-circle" alt="logo" style="float: left;margin-top: -10px;" width="45px"/>
                 <b style="float: left;margin-left: 4px;">E-PARKFAMILY</b>
                </div>
                                      ...
                                      <div class="modal-body" style="padding-bottom: 10px;">
                                        <h3 id="plat"></h3>
                                         ...
                                         <div class="form-group"><label class="col-sm-2 control-label text-right" style="font-size:14pt">Kembali</label>
                                          ...
                                          <input class="btn btn-primary" type="submit"  value="Bayar" name="btn_keluar" style="margin: 20px 17px 0 0; height: 40px; font-weight: bold;">
                                        </div>
                  ...
                  <div class="col-md-12 panel">
                    ...
                    <tbody>
                      ...
                      <tr style="font-size: 11pt">
                        ...
                        <td>
                          <a href="delete_data.php?kode=<?php echo $data['kode']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this record?');">Delete</a>
                          <a href="update_data.php?kode=<?php echo $data['kode']; ?>" class="btn btn-warning btn-sm">Edit</a>
                      </td>
                      </tr>
                      <?php } ?>
                    </tbody>
  ...
  $("#btnKeluar").click(function(){
    var kode = document.getElementById("kode_keluar").value; // Get the value of the input
    ...
    if(kode == "") {
      ...
      // Perform the AJAX call to fetch the total parking fee
      $.ajax({
        url: 'config/showdata.php',
        type: 'POST',
        data: {kode: kode}, // Send the kode value to the server
        dataType: 'html',
        success: function(response){
          // If the response is valid, populate the total input field
          if(response != 0){
            $("#total").val(response);
          } else {
            alert('Invalid Kode!'); // In case no matching data is found
          }
        },
        error: function(){
  ...
  // For calculating and showing the amount to pay
  $("#hitung").click(function(){
    ...
    if(isNaN(bayar)) {
      ...
      if(kembali > 10000) {
        ...
        $("#kembali").val(kembali.toFixed(2)); // Show the remaining balance
      }
    }
  });
</script>
